        ...
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Instagram" class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Slug</label>
                    <input type="text" name="slug" value="{{ old('slug') }}" placeholder="auto-generated if empty" class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 font-mono">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="icon" value="{{ old('icon') }}" placeholder="📸" class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="2" class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Optional description...">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition">Create Category</button>
            </div>
        </form>
    </div>
</x-admin-layout>
