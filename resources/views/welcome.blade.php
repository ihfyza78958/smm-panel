                            ...
                            <div class="mt-6">
                                <div class="relative">
                                    ...
                                    <div class="relative flex justify-center text-sm">
                                        <span class="px-2 bg-white/80 text-gray-500 font-medium">Or continue with</span>
                                    </div>
                                </div>

                                <div class="mt-4">
                                    <a href="{{ route('auth.social', 'google') }}" class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:shadow transition transform active:scale-95">
